...
from app.chat.planning_chat import chat_with_planning_docs
...
from app.retrievers.get_video_classificiation_from_twelve import get_classified_videos_from_twelve
...
workflow.add_node("get_videos", get_classified_videos_from_twelve)
workflow.add_node("chat_with_docs", chat_with_planning_docs)

workflow.add_edge("get_docs_from_vector_store", "validate_planning_docs")
workflow.add_edge("validate_planning_docs", "get_videos")
